...
METRICS = [
  ...
  {"key":"ret1_same","xaxis":True,"label":"UC-wide 1st-year retention — this period's entrants, any campus","short":"UC-wide 1st-yr retention","role":"outcome","fmt":"pct","grad":{"col":"r1","win":"same"},
  ...
  {"key":"grad4_same","xaxis":True,"label":"UC-wide 4-yr graduation — this period's entrants, any campus","short":"UC-wide 4-yr grad","role":"outcome","fmt":"pct","grad":{"col":"g4","win":"same"},
  ...
  {"key":"grad6_same","xaxis":True,"label":"UC-wide 6-yr graduation — this period's entrants, any campus","short":"UC-wide 6-yr grad","role":"outcome","fmt":"pct","grad":{"col":"g6","win":"same"},
